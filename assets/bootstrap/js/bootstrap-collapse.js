...
!function ($) {
  ...
  * ================================ */
  ...
  , reset: function (size) {
      ...
      this.$element
        .removeClass('collapsediv')
        [dimension](size || 'auto')
        [0].offsetWidth

      this.$element[size !== null ? 'addClass' : 'removeClass']('collapsediv')
  ...
  , transition: function (method, startEvent, completeEvent) {
      ...
      $.support.transition && this.$element.hasClass('collapsediv') ?
  ...
  * ==================== */
  ...
  $(document).on('click.collapsediv.data-api', '[data-toggle=collapsediv]', function (e) {
    var $this = $(this), href
